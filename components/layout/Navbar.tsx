...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-teal-900 via-cyan-900 to-teal-900 border-b border-teal-700 shadow-xl sticky top-0 z-50 backdrop-blur-sm bg-opacity-95">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 p-2 rounded-lg shadow-lg group-hover:scale-110 transition-transform">
              <Trophy className="w-6 h-6 text-teal-900" />
            </div>
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${active
                      ? 'bg-gradient-to-r from-yellow-400 to-yellow-500 text-teal-900 shadow-lg scale-105'
